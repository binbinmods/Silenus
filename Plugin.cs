...
namespace Silenus
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Silenus";
        public static string heroName = characterName;

        public static string subclassName = "King"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Silenus, the King.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Silenus",
                _contentFolder: "Silenus",
